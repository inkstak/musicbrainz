...
RSpec.describe '#artist', vcr: { cassette_name: 'artist' } do
  ...
  it { expect{ artist.urls            }.to raise_error(NoMethodError) }
  it { expect{ artist.relationships   }.to raise_error(NoMethodError) }
  it { expect{ artist.score           }.to raise_error(NoMethodError) }
...
RSpec.describe '#artists', vcr: { cassette_name: 'artist' } do
